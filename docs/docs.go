    ...
    "paths": {
        ...
        "/report": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "month MM, year YYYY",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal.reportRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/transactions": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "user id, preferred order (date/amount/",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal.HistoryRequest"
                        }
                    }
                ],
                "responses": {
